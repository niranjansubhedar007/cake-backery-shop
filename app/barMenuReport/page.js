    ...
    const fetchData = async () => {
      try {
        const response = await axios.get(
          `http://localhost:5000/api/order/bar-statistics${startDate && endDate
  ...
  return (
    <>
      ...
      <div className="container mx-auto mt-10 p-2 bg-white rounded-md shadow-md font-sans overflow-x-auto">
        <h2 className="text-xl font-bold mb-4 mt-2 text-orange-500">Sold Liquor Report</h2>
...
export default BarStatisticsComponent;
