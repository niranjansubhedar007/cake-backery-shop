  ...
  return (
    <>
      ...
      <div className="container mx-auto mt-10 p-2 bg-white rounded-md shadow-md font-sans overflow-x-auto">
        ...
        {/* <Flag /> */}
        <h1 className="text-xl font-bold mb-2 text-orange-500">Daily Menu Reports</h1>
            ...
            <table className="min-w-full divide-y divide-gray-200">
              ...
              <tbody>
                ...
                <tr className="bg-gray-100">
                  ...
                  <td className="px-4 py-2 whitespace-no-wrap border-b border-gray-200 font-bold">
                    {Math.round(calculateTotal("menuTotal")).toLocaleString(
                      "en-IN",
                  ...
                  {/* <td className="px-4 py-2 whitespace-no-wrap border-b border-gray-200 font-bold">
                                    ...
                                    <td className="px-4 py-2 whitespace-no-wrap border-b border-gray-200 font-bold">
                                        ₹{Math.round(calculateTotal("grandTotal"))}
                                    </td>
...
export default dailyMenuReport;